  ...
  return (
    <div className='w-full sm:w-[550px] xl:mx-[20px] xl:w-[700px] p-[16px] mb-[24px] min-h-[960px] bg-white'>
        ...
        <div className='grid gap-[24px]'>
            ...
            <div className=''>
                <p className='mb-[12px]'> Work Email (We give priority access to company email ids) </p>
                <input 
                  type="email"
                  value={workEmail}
                  onChange={(ev) => handleInputChange(ev)}
            ...
            <div className=''>
                <p className='mb-[12px]'> Company Website (without http:// or https://) </p>
                <input 
                  type="text"
            ...
            <div className=''>
                <p className='mb-[12px] text-[14px] leading-[22px] font-[400]'> Job Title </p>
            ...
            <div className=''>
                <p className='mb-[12px] text-[14px] leading-[22px] font-[400]'> JavaScript Library </p>
                <select className='bg-[#F3F3F3] border-[1px] border-solid border-[rgba(20,20,20,.1)] pl-[13px] pt-[3px] w-full h-[40px]'>
            ...
            <div className=''>
                <p className='mb-[12px] text-[14px] leading-[22px] font-[400]'> What are you hoping to achieve with CopyCat? </p>
                <select className='bg-[#F3F3F3] border-[1px] border-solid border-[rgba(20,20,20,.1)] pl-[13px] pt-[3px] w-full h-[40px]'>
                  ...
                  <option value="opel">Create Web Pages/Landing Pages at Scale</option>
                  <option value="audi">Others</option>
                </select>             
            </div>
