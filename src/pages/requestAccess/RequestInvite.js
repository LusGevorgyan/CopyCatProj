  ...
  return (
    <div className="grid gap-[20px] lg:flex justify-center items-center bg-[#E3F6F5] pt-[130px]">
        ...
        <div className="grid gap-[24px]">
          ...
          <div className="">
            <p className="mb-[12px] text-[14px] leading-[22px] font-[400]">
              {" "}
              Styling Formats (Press ctrl/cmd to select multiple options)*{" "}
            </p>
          ...
          <div className="">
            <p className="mb-[12px] text-[14px] leading-[22px] font-[400]">
              {" "}
              JavaScript Syntax/Formats (Select one)*{" "}
            </p>
            <select className="bg-[#F3F3F3] border-[1px] border-solid border-[rgba(20,20,20,.1)] pl-[13px] pt-[3px] w-full h-[40px]">
      ...
      <div className="w-full">
        <img
          src="https://uploads-ssl.webflow.com/602a49b4c90708f6641a192e/61499ca00b45e630fe216040_screen-detective-cat.png"
          className="mx-auto md:mx-0 w-[300px] sm:w-[400px] lg:w-[430px] lg:h-[270px]"
        />
      </div>
      <Link
        className="h-[35px] w-[150px] lg:hidden flex justify-center mx-auto mt-[62px]" to="/old-home">
